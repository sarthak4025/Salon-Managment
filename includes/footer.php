...
?>
              <li>
                <span class="fa fa-map-marker"></span> <p> wz-62 beri wala bagh j block hari nagar.</p>
              </li>
              <li><span class="fa fa-phone"></span><a href="tel:+7-800-999-800"> 7838255748</a></li>
              <li><span class="fa fa-envelope-open-o"></span><a href="mailto:parlour@mail.com" class="mail">
                sarthak4803@gmail.com </a></li><?php } ?>
            </ul>
          </div>
  ...
  <section class="w3l-footer-29-main w3l-copyright">
    <div class="container">
      <div class="row bottom-copies">
        <p class="col-lg-8 copy-footer-29">© 2024  skcoder </p>
